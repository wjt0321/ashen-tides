...
- Move `assets/art/c01/sprites/*` to `assets/art/c01/runtime/*`.
- Move `assets/vendor/foozle/*` to `assets/vendor/c01/foozle/*`.
- Move `assets/vendor/kenney/*` to `assets/vendor/c01/kenney/*`.
