...
> 依据：docs/current/product/PRD.md §5.3 蓝图（C09 交叉路/隐匿侦测、C10 双路/孢子治疗、C11 镜像双路/双相抗性/铸潮砧、C12 汇流路/可破坏掩体）与 §5.4 硬约束（每关 12–20 波、BuildNode 8–22、节点距路线 ≥24px、每关首引 ≤1 系统 + 2 敌）。
