...
- 从 `docs/current/art/ASSET_CATALOG.md` 中筛选少量候选，不批量下载。
...
- 产品范围：[PRD.md](../../current/product/PRD.md)
- 技术路线：[RESEARCH_REPORT.md](../../current/engineering/RESEARCH_REPORT.md)
- 资产与许可：[ASSET_CATALOG.md](../../current/art/ASSET_CATALOG.md)
- 总进度：[CHECKLIST.md](../../current/product/CHECKLIST.md)
