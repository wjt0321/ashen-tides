...
Version:
  1.1
Description:
  Some original & some reworked Cabbit pirate sprites for Stendhal.
Details:
...
Links:
  ...
  - OpenGameArt.org submission: https://opengameart.org/node/83642
  - See also: sources.md
Notes:
  - IMPORTANT: As part of Cabbit's attribution requirements, please
    ...
    lana-chan@yandex.ru
  - The "48x64_scale" & "48x64_scale2x" sprites will be replaced with
    touched-up & smoothed versions.
